...
# --------------------------------------------------------------------------- 80
# Build CPS
ENV CPS_VERSION="NP330.Nov-30-2024"
USER ${MTINV_USER}
WORKDIR ${DEV_DIR}
# RUN wget --no-check-certificate https://www.eas.slu.edu/eqc/eqc_cps/Download/NP330.Nov-30-2024.tgz \
#         && gunzip -c NP330.Nov-30-2024.tgz | tar xf - \
#         && cd PROGRAMS.330 \
#         && ./Setup LINUX6440 \
#         && ./C
